...
const defaultTestimonials: TestimonialsContent = {
  ...
  items: [
    ...
    },
    {
      ...
      content: 'Sistem inventory yang dibuat sangat membantu mengelola stok barang. Real-time dan akurat. Omzet toko kami meningkat sejak menggunakan sistem ini.',
      rating: 5,
    },
    {
      name: 'Ahmad Fauzi',
      role: 'CEO',
      company: 'Kopi Senja',
      content: 'Website dengan fitur reservasi meja dan menu digital yang dibuat sangat memudahkan operasional café kami. Pelayanan jadi lebih cepat dan pelanggan puas.',
      rating: 5,
    },
  ],
};
